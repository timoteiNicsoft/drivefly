...
$(document).ready(function() {
  ...
  $('#date_back').on('click', function(event) {
    ...
    $('#date_forw').on('click', function(event) {
        ...
        var link = document.getElementById("hrefdateprint");
        link.setAttribute("href", "./fpdf/daily_print.php?date="+myMoment.format('YYYY-MM-DD')+"&amp;airport=0&amp;type=");

        console.log("./fpdf/daily_print.php?date="+myMoment.format('YYYY-MM-DD')+"&amp;airport=0&amp;type=");
